...
import StudentAside from '../components/student-aside'
    ...
    <main class="p-6 sm:p-10 space-y-6">
      <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
        <div class="mr-6">
          ...
          <h2 class="text-gray-600 ml-0.5">Welcome to Your portal 'Name'</h2>
        </div>
      ...
      <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
          <div class="px-6 py-5 font-semibold border-b border-gray-100">Progress Report</div>
        ...
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            <span class="block text-2xl font-bold">Attendance</span>
            <span class="block text-gray-500">20/36</span>
          </div>
        </div>
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
        ...
        <div class="flex flex-col row-span-3 bg-white shadow rounded-lg">
          <div class="px-6 py-5 font-semibold border-b border-gray-100">Disciplinary Record</div>
        ...
        <div class="overflow-y-auto" >
            <ul class="p-6 space-y-6">
              ...
              <li class="flex items-center">
                ...
                <span class="ml-8 font-semibold">POLI 422</span>
              </li>
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                ...
                <span class="ml-8 font-semibold">INFS 442</span>
              </li>
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
              ...
              <li class="flex items-center">
                ...
                <span class="ml- font-semibold">ENG 849</span>
              </li>
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                ...
                <span class="ml-12 font-semibold">SOC 630</span>
              </li>
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                ...
                <span class="ml-8 font-semibold">POLI 443</span>
              </li>
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                ...
                <span class="ml-6 font-semibold">POLI 039</span>
              </li>
            </ul>
          </div>
      </div>
