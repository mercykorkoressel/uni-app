...
export default function ScheduleForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('adding promotion:', error);
      setErrorMessage('failed to add . Please try again.');
      setSuccessMessage('');
      ...
      <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
        ...
        <div>
            ...
            <div>
             ...
             <h1 class="font-semibold text-4xl ">Schedule</h1>
             <h1 class="text-3xl"></h1>
           
         </div>
         <form onSubmit={handleSubmit}>
             <p class="mb-5 leading-relaxed text-gray-600"> Upload students Schedule
             </p>
             <div class="mb-4">
                 <label for="course" class="text-sm leading-7 text-gray-600"> Course Title</label>
                 <input type="course" id="email" name="course" value={formData.Course} onChange={handleChange} 
             ...
             <div class="mb-4">
                 <label for="Day" class="text-sm leading-7 text-gray-600">Day</label>
                 <input type="Day" id="Day" name="Day"value={formData.Course} onChange={handleChange} 
                  class="w-full rounded border border-gray-300 bg-white py-1 px-3 text-base leading-8 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200" />
             </div>
             <div class="mb-4">
                 <label for="time" class="text-sm leading-7 text-gray-600">Time</label>
                 <input type="time" id="time" name="time" value={formData.Course} onChange={handleChange} 
                  class="w-full rounded border border-gray-300 bg-white py-1 px-3 text-base leading-8 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200" />
             </div>
