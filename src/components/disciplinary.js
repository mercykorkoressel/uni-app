...
export default function Disciplinary() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSubmit.append('title', formData.tittle);
      ...
      setErrorMessage('Failed to add disciplinary record. Please try again.');
      setSuccessMessage('');
    ...
    <section class="grid md:grid-cols-2 xl:grid-cols-2 xl:grid-rows-2 xl:grid-flow-col gap-6">
      <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
       <div>
         ...
         <h1 class="font-semibold text-4xl mb-4">Disciplinary Record</h1></div>
         <p class="mb-5 leading-relaxed text-gray-600">Input Student Disciplinary Record
         </p>
         ...
         <div class="mb-4">
             ...
             <input type="email" id="email" name="email" value={formData.tittle} onChange={handleChange} 
