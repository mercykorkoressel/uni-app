  ...
  <main class="p-6 sm:p-10 space-y-6">
    ...
    <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
      ...
      <div class="flex items-center p-8 bg-white shadow rounded-lg">
        ...
        <div>
          ...
          <span class="block text-gray-500">Wellperforming</span>
        </div>
      </div>
    </section>
    <section class="grid md:grid-cols-2 xl:grid-cols-2 xl:grid-rows-2 xl:grid-flow-col gap-6">
      ...
      <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
        <div>
          <div>
          <form action='https://formspree.io/f/mqkrwvrr' method='POST'>

<div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
  
      <div class="max-w-xl mx-auto mt-16 flex w-full flex-col border rounded-lg bg-white p-8">
   <h2 class="title-font mb-1 text-lg font-medium text-gray-900">Enquiry Form</h2>
   <p class="mb-5 leading-relaxed text-gray-600">
       send and Enquiry
   </p>
   <div class="mb-4">
       <label for="text" class="text-sm leading-7 text-gray-600">Title</label>
       <input type="text" id="text" name="text" class="w-full rounded border border-gray-300 bg-white py-1 px-3 text-base leading-8 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200" />
   </div>
